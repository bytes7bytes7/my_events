...
import '../../../features/common/application/blocs/auth/auth_bloc.dart' as _i65;
...
import '../../../features/common/domain/entities/event.dart' as _i19;
...
import '../../../features/common/domain/repositories/user_repository.dart'
    as _i47;
import '../../../features/common/domain/services/auth_service.dart' as _i52;
...
import '../../../features/home/application/blocs/news/news_bloc.dart' as _i57;
...
import '../../../features/home/application/providers/upcoming_events_string_provider.dart'
    as _i45;
import '../../../features/home/application/view_models/event_vm.dart' as _i20;
import '../../../features/home/application/view_models/news_category_vm.dart'
    as _i23;
import '../../../features/home/application/view_models/news_vm.dart' as _i26;
import '../../../features/home/application/view_models/onboarding_tip_vm.dart'
    as _i29;
import '../../../features/home/domain/entities/news.dart' as _i25;
import '../../../features/home/domain/entities/news_category.dart' as _i22;
...
import '../../../features/home/domain/value_objects/onboarding_tip.dart'
    as _i63;
import '../../../features/home/domain/value_objects/value_objects.dart' as _i28;
...
import '../../coordinators/onboarding_coordinator.dart' as _i39;
import '../modules/shared_prefs_module.dart' as _i67;
...
Future<_i1.GetIt> init(
  ...
  gh.lazySingleton<_i15.Mapper<_i19.Event, _i20.EventVM>>(
      () => _i21.EventToEventVMMapper(gh<_i9.DateTimeBeautifyProvider>()));
  gh.lazySingleton<_i15.Mapper<_i22.NewsCategory, _i23.NewsCategoryVM>>(
      () => _i24.NewsCategoryToNewsCategoryVMMapper());
  gh.lazySingleton<_i15.Mapper<_i25.News, _i26.NewsVM>>(
      () => _i27.NewsToNewsVMMapper(
            gh<_i9.DateTimeBeautifyProvider>(),
            gh<_i11.DurationBeautifyProvider>(),
          ));
  gh.lazySingleton<_i15.Mapper<_i28.OnboardingTip, _i29.OnboardingTipVM>>(
      () => _i30.OnboardingTipToOnboardingTipVMMapper());
  ...
  gh.lazySingleton<_i38.OnboardingCoordinator>(
      () => _i39.ProdOnboardingCoordinator());
  gh.lazySingleton<_i40.OnboardingStringProvider>(
      () => _i41.ProdOnboardingStringProvider());
  await gh.factoryAsync<_i42.SharedPreferences>(
    () => sharedPrefsModule.prefs,
    preResolve: true,
  );
  gh.lazySingleton<_i43.TicketRepository>(() => _i44.TestTicketRepository());
  gh.lazySingleton<_i45.UpcomingEventsStringProvider>(
      () => _i46.ProdUpcomingEventsStringProvider());
  gh.lazySingleton<_i47.UserRepository>(() => _i48.TestUserRepository());
  gh.factory<_i49.AccountBloc>(() => _i49.AccountBloc(
  ...
  gh.factory<_i57.NewsBloc>(() => _i57.NewsBloc(
        gh<_i34.NewsRepository>(),
        gh<_i36.NewsStringProvider>(),
        gh<_i58.NewsCoordinator>(),
        gh<_i15.Mapper<_i25.News, _i26.NewsVM>>(),
      ));
  gh.factory<_i59.NewsListBloc>(() => _i59.NewsListBloc(
        gh<_i34.NewsRepository>(),
        gh<_i60.NewsListStringProvider>(),
        gh<_i15.Mapper<_i22.NewsCategory, _i23.NewsCategoryVM>>(),
        gh<_i15.Mapper<_i25.News, _i26.NewsVM>>(),
      ));
  gh.factory<_i61.OnboardingBloc>(() => _i61.OnboardingBloc(
        gh<_i62.OnboardingRepository>(),
        gh<_i15.Mapper<_i63.OnboardingTip, _i29.OnboardingTipVM>>(),
        gh<_i40.OnboardingStringProvider>(),
        gh<_i38.OnboardingCoordinator>(),
      ));
  gh.factory<_i64.UpcomingEventsBloc>(() => _i64.UpcomingEventsBloc(
        gh<_i13.EventRepository>(),
        gh<_i15.Mapper<_i19.Event, _i20.EventVM>>(),
        gh<_i45.UpcomingEventsStringProvider>(),
      ));
  gh.factory<_i65.AuthBloc>(() => _i65.AuthBloc(
        gh<_i52.AuthService>(),
        gh<_i7.AuthStringProvider>(),
        gh<_i66.AuthCoordinator>(),
      ));
  return getIt;
}
